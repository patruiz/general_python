...
def correlation():
    ...
    inside_df = pd.read_csv(r"C:\Users\pr19556\OneDrive - Applied Medical\Documents\Investigations\02 - MD Jaw Gap\Starrett Data\1524590\Inside\1524590_Inside_PR.csv", usecols=cols_to_read)
